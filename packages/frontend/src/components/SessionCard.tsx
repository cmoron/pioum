  ...
  if (compact) {
    return (
      <div className={`card overflow-hidden ${isPast ? "bg-primary-50" : ""}`}>
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                <span
                  className={`font-medium capitalize text-sm ${isPast ? "text-primary-600" : "text-primary-800"}`}
                >
                  {formatSessionDate(session.date)}
                </span>
                <span
                  className={`text-xs ${isPast ? "text-primary-400" : "text-primary-500"}`}
                >
              ...
              <div
                className={`flex items-center gap-2 text-xs ${isPast ? "text-primary-400" : "text-primary-500"}`}
              >
                <span>
        ...
        {expanded && (
          <div
            className={`border-t p-3 space-y-3 ${isPast ? "border-primary-100" : "border-primary-200"}`}
          >
            ...
            <span className="flex items-center gap-1">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M8 7h8m-8 5h8m-4 9l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v9a2 2 0 01-2 2h-5l-4 4z"
                />
              </svg>
              {session.cars.length}
            </span>
